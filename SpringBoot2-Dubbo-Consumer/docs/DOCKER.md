...
# docker部署
```
docker run -dp $SERVER_PORT:$SERVER_PORT -t com.test.dubbo/springboot2-dubbo-consumer:1.0
```
## 查看docker部署日志
```
...
```
image: harbor-registry/test/com.test.dubbo/springboot2-dubbo-consumer:1.0
```
Second:修改端口
```
